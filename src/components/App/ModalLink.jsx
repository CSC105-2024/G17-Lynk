  ...
  return (
    <div className={showHideClassName}>
      <div className='bg-[var(--modal-bg-color)] rounded-lg p-8 w-full max-w-md shadow-lg'>
        ...
        {/* Link Input */}
        <div className='mb-4'>
          <label htmlFor='link' className='block text-[var(--app-text-color)] text-sm font-semibold mb-2'>
            Link
          </label>
          <input
            type='text'
        ...
        {/* Playlist Dropdown */}
        <div className='mb-4'>
          <label htmlFor='playlist' className='block text-[var(--app-text-color)] text-sm font-semibold mb-2'>
            Playlist
          </label>
          <select
            id='playlist'
        ...
        {/* Name Input */}
        <div className='mb-4'>
          <label htmlFor='name' className='block text-[var(--app-text-color)] text-sm font-semibold mb-2'>
            Name
          </label>
          <input
            type='text'
        ...
        {/* Tag Dropdown */}
        <div className='mb-4'>
          <label htmlFor='tag' className='block text-[var(--app-text-color)] text-sm font-semibold mb-2'>
            Tag
          </label>
          <select
            id='tag'
        ...
        <div className='mb-6'>
          <label htmlFor='description' className='block text-[var(--app-text-color)] text-sm font-semibold mb-2'>
            Description
          </label>
          <textarea
            id='description'
