...
function useComposedRefs2(...refs) {
  return React13.useCallback(composeRefs3(...refs), refs);
}
...
var Portal = React31.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime16.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function useComposedRefs3(...refs) {
  return React33.useCallback(composeRefs4(...refs), refs);
}
...
var useLayoutEffect24 = (globalThis == null ? void 0 : globalThis.document) ? React35.useLayoutEffect : () => {
};
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React37.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime18.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React37.isValidElement(newElement) ? React37.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var useInsertionEffect2 = React40[" useInsertionEffect ".trim().toString()] || useLayoutEffect24;
