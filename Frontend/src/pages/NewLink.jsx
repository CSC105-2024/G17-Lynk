...
// const NewLink = ({ show, handleClose }) => {
...
const NewLink = () => {
  return (
    <div>
      <form className='flex flex-col gap-4 p-4 bg-[var(--modal-bg-color)] rounded-lg shadow-lg w-full max-w-md'>
        <div className='flex justify-between items-center mb-4'>
          <h2 className='text-xl font-bold text-[var(--app-text-color)]'>
            Create a New Link
          </h2>
    ...
    // <div className='fixed inset-0 w-full h-full bg-[var(--main-bg-color)] bg-opacity-60 flex justify-center items-center z-100 overflow-auto'>
    //   <div className='bg-[var(--modal-bg-color)] rounded-lg p-8 w-full max-w-md shadow-lg'>
    //     {/* Modal Header */}
    //     <div className='flex justify-between items-center mb-4'>
    //       <h2 className='text-xl font-bold text-[var(--app-text-color)]'>
