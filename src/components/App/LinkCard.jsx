...
const LinkCard = ({ data, onDelete }) => {
  ...
  return (
    <div className='bg-[var(--link-card-bg)] rounded-lg shadow py-3 px-3 md:px-10 hover:bg-[var(--link-card-hover-bg)] w-85 md:w-full'>
      
      {/* Top section: icon, link name, and more options */}
